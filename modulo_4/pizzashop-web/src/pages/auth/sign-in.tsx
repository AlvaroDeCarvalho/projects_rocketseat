...
export function SignIn() {
    ...
    const {register, handleSubmit, formState: {isSubmitting}} = useForm<SignInFormType>({resolver: zodResolver(signInForm)})
            ...
            <div className='p-8'>
                ...
                <div className='W-[320px] flex flex-col justify-center gap-6'>
                    <div className=' flex flex-col gap-2 text-center '>
                        ...
                        <p className='text-sm text-muted-foreground'>acompanhe suas vender pelo painel do parceiro</p>
                        </div>
                        <form className='space-y-4 ' onSubmit={handleSubmit(handelSignIn)}>
                                <div className="space-y-2">
                                    <Label htmlFor='email' {...register}>Seu e-mail</Label>
